...
static boost::function<void( void )> Move3DDrawClearHandles;
...
void move3d_set_fct_draw_clear_handles( boost::function<void( void )> fct ) { Move3DDrawClearHandles = fct; }
