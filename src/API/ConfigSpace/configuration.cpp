...
static boost::function<double*(Robot*, double*)>
    Move3DConfigurationConstructorConfigStruct;
static boost::function<void(const Configuration& q_s, Configuration& q_t)>
    Move3DConfigurationAssignment;
static boost::function<void(Robot*, double*)> Move3DConfigurationClear;
static boost::function<void(Robot*, double*)>
    Move3DConfigurationConvertToRadians;
static boost::function<confPtr_t(Robot*, double*)>
    Move3DConfigurationConvertToDegrees;
static boost::function<double*(Robot*, double*)>
    Move3DConfigurationGetStructCopy;
static boost::function<double(Robot*, double*, double*, bool)>
    Move3DConfigurationDist;
static boost::function<double(
    Robot*, const Configuration&, const Configuration&, int)>
    Move3DConfigurationDistChoice;
static boost::function<bool(Robot* R)> Move3DConfigurationInCollision;
static boost::function<bool(Robot*, double*, bool)>
    Move3DConfigurationIsOutOfBounds;
static boost::function<void(Robot*, double*)>
    Move3DConfigurationAdaptCircularJointLimits;
static boost::function<double(Robot*)> Move3DConfigurationDistEnv;
static boost::function<bool(Robot*, double*, double*, bool)>
    Move3DConfigurationEqual;
static boost::function<void(Robot*, double*)> Move3DConfigurationCopy;
static boost::function<void(Robot*, double*, double*)>
    Move3DConfigurationCopyPassive;
static boost::function<void(Robot* R, double*, double*, double*)>
    Move3DConfigurationAdd;
static boost::function<void(Robot* R, double*, double*, double*)>
    Move3DConfigurationSub;
static boost::function<void(Robot* R, double*, double*, double)>
    Move3DConfigurationMult;
...
void move3d_set_fct_configuration_constructor_robot(
    boost::function<double*(Robot*)> fct)
{
  Move3DConfigurationConstructorRobot = fct;
}
void move3d_set_fct_configuration_constructor_config_struct(
    boost::function<double*(Robot*, double*)> fct)
{
  Move3DConfigurationConstructorConfigStruct = fct;
}
void move3d_set_fct_configuration_assignment(
    boost::function<void(const Configuration& q_s, Configuration& q_t)> fct)
{
  Move3DConfigurationAssignment = fct;
}
void move3d_set_fct_configuration_clear(
    boost::function<void(Robot*, double*)> fct)
{
  Move3DConfigurationClear = fct;
}
void move3d_set_fct_configuration_convert_to_radians(
    boost::function<void(Robot*, double*)> fct)
{
  Move3DConfigurationConvertToRadians = fct;
}
void move3d_set_fct_configuration_convert_to_degrees(
    boost::function<confPtr_t(Robot*, double*)> fct)
{
  Move3DConfigurationConvertToDegrees = fct;
}
void move3d_set_fct_configuration_get_struct_copy(
    boost::function<double*(Robot*, double*)> fct)
{
  Move3DConfigurationGetStructCopy = fct;
}
void move3d_set_fct_configuration_dist(
    boost::function<double(Robot*, double*, double*, bool)> fct)
{
  Move3DConfigurationDist = fct;
}
void move3d_set_fct_configuration_dist_choice(boost::function<
    double(Robot*, const Configuration&, const Configuration&, int)> fct)
{
  Move3DConfigurationDistChoice = fct;
}
void move3d_set_fct_configuration_in_collision(
    boost::function<bool(Robot* R)> fct)
{
  Move3DConfigurationInCollision = fct;
}
void move3d_set_fct_configuration_is_out_of_bounds(
    boost::function<bool(Robot*, double*, bool)> fct)
{
  Move3DConfigurationIsOutOfBounds = fct;
}
void move3d_set_fct_configuration_adapt_circular_joint_limits(
    boost::function<void(Robot*, double*)> fct)
{
  Move3DConfigurationAdaptCircularJointLimits = fct;
}
void move3d_set_fct_configuration_dist_env(boost::function<double(Robot*)> fct)
{
  Move3DConfigurationDistEnv = fct;
}
void move3d_set_fct_configuration_equal(
    boost::function<bool(Robot*, double*, double*, bool)> fct)
{
  Move3DConfigurationEqual = fct;
}
void move3d_set_fct_configuration_copy(
    boost::function<void(Robot*, double*)> fct)
{
  Move3DConfigurationCopy = fct;
}
void move3d_set_fct_configuration_copy_passive(
    boost::function<void(Robot*, double*, double*)> fct)
{
  Move3DConfigurationCopyPassive = fct;
}
void move3d_set_fct_configuration_add(
    boost::function<void(Robot* R, double*, double*, double*)> fct)
{
  Move3DConfigurationAdd = fct;
}
void move3d_set_fct_configuration_sub(
    boost::function<void(Robot* R, double*, double*, double*)> fct)
{
  Move3DConfigurationSub = fct;
}
void move3d_set_fct_configuration_mult(
    boost::function<void(Robot* R, double*, double*, double)> fct)
{
  Move3DConfigurationMult = fct;
}
void move3d_set_fct_configuration_print(
    boost::function<void(Robot* R, double*, bool)> fct)
{
  Move3DConfigurationPrint = fct;
}
      ...
      _Robot(R)
{
  if (_Robot == NULL) {
    ...
    _Configuration =
        noCopy ? C : Move3DConfigurationConstructorConfigStruct(R, C);
      ...
      _Robot(conf._Robot)
{
  if (_Robot == NULL) {
    ...
    _Configuration =
        Move3DConfigurationConstructorConfigStruct(_Robot, conf._Configuration);
  }
}
...
Configuration::~Configuration() { this->Clear(); }
...
// Accessors
Robot* Configuration::getRobot() { return _Robot; }

double* Configuration::getConfigStructConst() const { return _Configuration; }
...
void Configuration::setConfiguration(double* C) { _Configuration = C; }
...
{
  return Move3DConfigurationDist(
      _Robot, _Configuration, Conf._Configuration, print);
}
...
void Configuration::setAsNotTested() { _CollisionTested = false; }
...
bool Configuration::equal(Configuration& Conf, bool print)
{
  ...
  return Move3DConfigurationEqual(
      _Robot, _Configuration, Conf.getConfigStruct(), print);
}
...
confPtr_t Configuration::add(Configuration& C)
{
  ...
  Move3DConfigurationAdd(
      _Robot, _Configuration, C.getConfigStruct(), ptrQ->getConfigStruct());
...
confPtr_t Configuration::mult(double coeff)
{
  ...
  Move3DConfigurationMult(
      _Robot, _Configuration, ptrQ->getConfigStruct(), coeff);
...
Eigen::VectorXd Configuration::getEigenVector(int startIndex,
                                              int endIndex) const
{
...
void Configuration::setCostAsNotTested() { _CostTested = false; }
