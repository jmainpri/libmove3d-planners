...
void initPlannerParameters()
{
    ...
    // HRI
    myBoolMap.insert( std::make_pair( PlanParam::useLegibleCost,             new boolContainer(false)));
    ...
    // Drawing (gl)
    myBoolMap.insert( std::make_pair( PlanParam::drawModule,                 new boolContainer(true)));
    myBoolMap.insert( std::make_pair( PlanParam::drawNaturalColor,           new boolContainer(false)));
    ...
    myIntMap.insert(std::make_pair( PlanParam::nb_pointsOnTraj,              new intContainer(100)));
    ...
    myIntMap.insert(std::make_pair( PlanParam::replanningInitMethod,         new intContainer(0)));
