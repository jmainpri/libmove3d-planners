...
public:
    ...
    Move3D::Trajectory& getCurrentTraj() { return m_CurrentTraj; }
...
protected:
    ...
    std::pair<bool,Move3D::Trajectory> concat_to_current_traj(const Move3D::Trajectory& newPortion);
    ...
    Move3D::Trajectory m_CurrentTraj;
