...
find_path (p3d_INCLUDE_DIR env.hpp
 PATHS /Users/jmainpri/workspace/ooMove3d-core/p3d  $ENV{ROBOTPKG_BASE}/include/ooMove3D-core/p3d/
 )

find_path (OOMOVE3D-CORE_INCLUDE_DIR P3d-pkg.h
 PATHS /Users/jmainpri/workspace/ooMove3d-core/include $ENV{ROBOTPKG_BASE}/include/ooMove3D-core/include/
 )

find_library (OOMOVE3D-CORE_LIBRARIES ooMove3D-core
  PATHS ${OOMOVE3D-CORE_LIB} /Users/jmainpri/workspace/ooMove3d-core/build_lib/Debug/lib/macintel $ENV{ROBOTPKG_BASE}/lib
  )
message(blalbla)
